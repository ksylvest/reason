...
// KSReason
#define COCOAPODS_POD_AVAILABLE_KSReason
#define COCOAPODS_VERSION_MAJOR_KSReason 1
#define COCOAPODS_VERSION_MINOR_KSReason 0
#define COCOAPODS_VERSION_PATCH_KSReason 7
